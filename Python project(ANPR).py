...
def plot_image(img1, title1=""):     # define a function to plot image
...
#plot_image(image,"Orignal Image")
...
for c in cnts:
        ...
        if len(approx) == 4:  # Select the contour with 4 corners
            ...
            cv2.imwrite('Number plate image.jpg', new_img) #Store new image
            idx+=1
...
crop_img=cv2.imread('contour image.jpg')
